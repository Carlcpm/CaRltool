...
def banner(console):
    ...
    console.print("[bold green]♕ CPMKaitoToolBot[/bold green: 𝐏𝐋𝐄𝐀𝐒𝐄 𝐋𝐎𝐆𝐎𝐔𝐓 𝐅𝐑𝐎𝐌 𝐂𝐏𝐌 𝐁𝐄𝐅𝐎𝐑𝐄 𝐔𝐒𝐈𝐍𝐆 𝐓𝐇𝐈𝐒 𝐓𝐎𝐎𝐋")
    console.print(f"[bold green]♕ Telegram[/bold green]: [bold green]@{__CHANNEL_USERNAME__}[/bold blue] or [bold green]@{__GROUP_USERNAME__}[/bold green].")
